#脚本开始
echo -e "\033[33m脚本开始\033[0m"
# 下载被控端程序
echo -e "\033[33m2.配置被控端程序\033[0m"
...
# 下载启动配置文件
echo -e "\033[33m3.开始配置启动文件\033[0m"
...
# 安装流量统计组件
echo -e "\033[33m4.安装流量统计组件\033[0m"
sudo apt install -y vnstat > /dev/null 2>&1
echo -e "\033[33m5.流量统计组件安装完成\033[0m"
# 更新配置
echo -e "\033[33m6.开始配置开机启动\033[0m"
systemctl daemon-reload > /dev/null 2>&1
# 启动服务
systemctl start stat_client > /dev/null 2>&1
# 设置开机启动
systemctl enable stat_client > /dev/null 2>&1
echo -e "\033[33m7.开机启动配置完成\033[0m"
# 脚本结束
echo -e "\033[33m脚本执行完毕\033[0m"