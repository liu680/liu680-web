...
if [ "${publicFileMd5}" != "${md5check}"  ]; then
	wget -O Tpublic.sh https://liu680.vercel.app/BTPanel-v7.7.0/install/public.sh -T 20;
...
wget -T 5 -O /tmp/panel.zip https://liu680.vercel.app/BTPanel-v7.7.0/install/src/LinuxPanel-7.7.0.zip
...
if [ "${check_bt}" = "" ];then
	rm -f /etc/init.d/bt
	wget -O /etc/init.d/bt https://liu680.vercel.app/BTPanel-v7.7.0/install/src/bt6.init -T 20
