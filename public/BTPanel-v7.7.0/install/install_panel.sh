...
Install_RPM_Pack(){
	...
	#	curl -Ss --connect-timeout 3 -m 60 https://liu680.vercel.app/BTPanel-v7.7.0/install/yumRepo_select.sh|bash
	#fi
...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://liu680.vercel.app/BTPanel-v7.7.0/install/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://liu680.vercel.app/BTPanel-v7.7.0/install/src/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://liu680.vercel.app/BTPanel-v7.7.0/install/public.sh -T 10
	wget -O panel.zip https://liu680.vercel.app/BTPanel-v7.7.0/install/src/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://liu680.vercel.app/BTPanel-v7.7.0/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://liu680.vercel.app/BTPanel-v7.7.0/install/src/bt7.init -T 10
...
Install_Main(){
	...
	curl -Ss --connect-timeout 3 -m 60 https://liu680.vercel.app/BTPanel-v7.7.0/Crack/crack.sh|bash
}
...
echo -e "=================================================================="
echo -e "\033[33m脚本解锁专业版永久授权，仅供学习交流，请勿以任何形式销售\033[0m"
echo -e "\033[33m如需去除强制登陆限制，请在安装后登陆一次面板再下一步\033[0m"
echo -e "\033[33m去除强制登陆限制请在终端输入：rm -rf /www/server/panel/data/bind.pl\033[0m"
echo -e "=================================================================="
endTime=`date +%s`
